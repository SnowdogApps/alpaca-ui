    ...
    template: `
      <app>
        <alpaca-catalog-list-item
          ...
          :buttonWishlist="data.buttonWishList.iconId"
          :buttonCompare="data.buttonCompare.iconId"
          :ariaLabelWishList="data.buttonWishList.ariaLabel"
          :ariaLabelCompare="data.buttonCompare.ariaLabel"
