<template>
  <footer class="footer">
    <div class="footer__handler row container">
      <alpaca-button
        icon="arrow-up"
      ...
      <section class="footer__newsletter col-xs-12 col-lg-3">
        <!--TODO Add newsletter component-->
      </section>
      <section class="footer__links col-xs-12 col-lg-9">
