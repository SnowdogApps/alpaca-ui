...
import AlpacaTab from '@/components/02-elements/tabs/Tab.vue'
import AlpacaTabsContainer from '@/components/02-elements/tabs/TabsContainer.vue'
import AlpacaTabContent from '@/components/02-elements/tabs/TabContent.vue'
import AlpacaAdditionalContent from '@/components/03-modules/additional-content/AdditionalContent.vue'
import AlpacaCatalogGridItem from '@/components/03-modules/catalog-grid-item/CatalogGridItem.vue'
import AlpacaGallery from '@/components/03-modules/gallery/Gallery.vue'
import AlpacaBriefInfo from '@/components/03-modules/brief-info/BriefInfo.vue'
import AlpacaReviewSummary from '@/components/03-modules/review/review-summary/ReviewSummary.vue'
import AlpacaQuantityUpdate from '@/components/03-modules/quantity-update/QuantityUpdate.vue'
import AlpacaSlider from '@/components/03-modules/slider/Slider.vue'
